...
var _viewsProductView = require('./views/productView');
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
var _viewsProductViewDefault = _parcelHelpers.interopDefault(_viewsProductView);
var _viewsItemView = require('./views/itemView');
var _viewsItemViewDefault = _parcelHelpers.interopDefault(_viewsItemView);
var _viewsCartView = require('./views/cartView');
var _viewsCartViewDefault = _parcelHelpers.interopDefault(_viewsCartView);
var _viewsNavView = require('./views/navView');
var _viewsNavViewDefault = _parcelHelpers.interopDefault(_viewsNavView);
var _viewsHeroView = require('./views/heroView');
var _viewsHeroViewDefault = _parcelHelpers.interopDefault(_viewsHeroView);
// Show and hide cart overlay
const controlCart = () => {
  _viewsNavViewDefault.default.addCartButtonHandler(_viewsCartViewDefault.default.showCart);
  _viewsCartViewDefault.default.addCloseButtonHandler(_viewsCartViewDefault.default.hideCart);
};
const showCountAndTotal = () => {
  _model.getCount();
  _viewsNavViewDefault.default.showCount(_model.state.count);
  _model.getTotal();
  _viewsCartViewDefault.default.showTotal(_model.state.total);
};
const addButtonsListeners = () => {
  _viewsCartViewDefault.default.addDecreaseItemHandeler(decreaseItem);
  _viewsCartViewDefault.default.addIncreaseItemHandeler(increaseItem);
};
const renderUpdatedCart = () => {
  _viewsCartViewDefault.default.clearCart();
  _model.state.cart.forEach(item => {
    _viewsCartViewDefault.default.renderCart(item);
  });
};
const updateAll = () => {
...
const increaseItem = e => {
  ...
  for (let item of _model.state.cart) {
    if (item.id === clickedId) {
      _model.addItemToCartState(clickedId);
      _viewsCartViewDefault.default.updateCountCart(clicked, item.quantity);
      showCountAndTotal();
    }
  }
};
...
const decreaseItem = e => {
  ...
  for (let item of _model.state.cart) {
    if (item.id === clickedId) {
      if (item.quantity == 1) {
        _model.removeItemFromCartState(clickedId);
        // CartView.hideCart();
        updateAll();
      }
      ;
      if (item.quantity > 1) {
        _model.decreaseItemFromCartState(clickedId);
        _viewsCartViewDefault.default.updateCountCart(clicked, item.quantity);
        showCountAndTotal();
      }
    }
...
const addItemToCart = e => {
  ...
  _model.addItemToCartState(clickedIndex);
  updateAll();
  // show cart after item added
  _viewsCartViewDefault.default.showCart();
};
// fetch data and render products with button
const controlProducts = async () => {
  _viewsProductViewDefault.default.renderSpinner();
  // get the data into state
  await _model.fetchData();
  // clear spinne
  _viewsProductViewDefault.default.clearSpinner();
  // render Products
  await _model.state.products.forEach(product => {
    _viewsProductViewDefault.default.render(product);
  });
  // add mouseover and mouse effect
  await _viewsItemViewDefault.default.mouseOver(_viewsItemViewDefault.default.showButton);
  await _viewsItemViewDefault.default.mouseOut(_viewsItemViewDefault.default.hideButton);
  await _viewsItemViewDefault.default.addInsertButtonHandler(addItemToCart);
};
const updateCart = () => {
  const cartJSON = localStorage.getItem('cart');
  const cart = JSON.parse(cartJSON);
  _model.updateCartState(cart);
  updateAll();
};
const init = () => {
  controlProducts();
  controlCart();
  _viewsHeroViewDefault.default.addScrollHandler();
  updateCart();
  _viewsCartViewDefault.default.addClearHandeler(clearCart);
};
init();

},{"./model":"1hp6y","regenerator-runtime":"62Qib","./views/productView":"7ufMu","./views/itemView":"1h6lY","./views/cartView":"8f3y9","./views/navView":"3p5tB","./views/heroView":"5iYNb","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"1hp6y":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
...
_parcelHelpers.export(exports, "getCount", function () {
  return getCount;
});
_parcelHelpers.export(exports, "updateCartState", function () {
  return updateCartState;
});
_parcelHelpers.export(exports, "getTotal", function () {
  return getTotal;
});
_parcelHelpers.export(exports, "removeItemFromCartState", function () {
  return removeItemFromCartState;
});
_parcelHelpers.export(exports, "clearCart", function () {
  return clearCart;
});
_parcelHelpers.export(exports, "decreaseItemFromCartState", function () {
  return decreaseItemFromCartState;
});
_parcelHelpers.export(exports, "addItemToCartState", function () {
  return addItemToCartState;
});
require('regenerator-runtime');
...
const fetchData = async function () {
  try {
    const res = await fetch(_config.API_URL);
...
const getCount = () => {
  const count = state.cart.reduce((accumulator, _, index) => accumulator + state.cart[index].quantity, 0);
  state.count = count;
};
const updateLocal = () => {
  localStorage.clear();
...
const updateCartState = localCart => {
  state.cart = localCart;
};
const getTotal = () => {
  const total = state.cart.reduce((accumulator, _, index) => accumulator + state.cart[index].quantity * state.cart[index].price, 0);
  state.total = total.toFixed(2);
};
const removeItemFromCartState = index => {
  const newCart = [];
...
const decreaseItemFromCartState = index => {
  let exists;
  for (let i = 0; i < state.cart.length; i++) {
...
const addItemToCartState = index => {
  let exists = undefined;
  if (state.cart.length) for (let i = 0; i < state.cart.length; i++) {
    if (state.cart[i].id === state.products[index - 1].id) exists = i;
  }
  if (exists !== undefined) {
    state.cart[exists].quantity += 1;
...
},{"regenerator-runtime":"62Qib","./config":"6pr2F","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"62Qib":[function(require,module,exports) {
/**
...
const API_URL = 'https://mocki.io/v1/c0ef5364-4cfa-44a2-b5aa-53f466916b73';
...
},{}],"7ufMu":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
class ProductView {
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"1h6lY":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
class ItemView {
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"8f3y9":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
class CartView {
  ...
  _genaerateItemMarkup = ({id, imageUrl, title, price, quantity}) => {
    return `<div class="cart__item item" id="item" data-id=${id}>
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"3p5tB":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
class NavView {
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"5iYNb":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
class HeroView {
  ...
  addScrollHandler() {
    this._shopButton.addEventListener('click', () => {
      this._productsSection.scrollIntoView({
        behavior: 'smooth'
      });
    });
  }
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}]},["7BONy","3miIZ"], "3miIZ", "parcelRequirea9d1")
